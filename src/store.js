export default {
  ...
  destinations: [
    ...
    },
    {
      ...
      id: 5,
      description:
        "Turkey has a lot of great destinations to offer. Exceptional landmarks, wonderful natural sceneries, historical legacies and a rich culture. Turkey is renowned for its hospitality and is always eager to please. The perfect Turkish experience is just around the corner.",
      experiences: [
        {
          name: "Maiden Tower",
          slug: "maiden-tower",
          image: "maiden-tower.jpeg",
          description:
